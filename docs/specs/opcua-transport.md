...
- **Issues**: AGR-981 (this spec), AGR-983 (address/config), AGR-984 (pull client), AGR-982/985 (acceptance), AGR-991 (secure channel)
- **Out of scope**: secrets UX for passwords and private keys (M3, AGR-992), subscriptions beyond the placeholder below (M2, AGR-987/988/989)
