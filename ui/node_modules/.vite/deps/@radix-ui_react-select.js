...
import {
  createCollection,
  useDirection
} from "./chunk-G5LJDHNB.js";
import {
  usePrevious,
  useSize
} from "./chunk-CPVRKB5Z.js";
import {
  composeEventHandlers,
  useControllableState,
  useLayoutEffect2
} from "./chunk-GZ34SDZ7.js";
import {
  require_react_dom
...
var Primitive = NODES.reduce((primitive, node) => {
  const Slot9 = createSlot(`Primitive.${node}`);
  const Node2 = React3.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot9 : node;
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  const Slot9 = createSlot2(`Primitive.${node}`);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React11.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React11.isValidElement(newElement) ? React11.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  const Slot9 = createSlot3(`Primitive.${node}`);
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React15.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime12.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React15.isValidElement(newElement) ? React15.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  const Slot9 = createSlot4(`Primitive.${node}`);
...
var PopperAnchor = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime14.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React18.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React18.isValidElement(newElement) ? React18.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  const Slot9 = createSlot5(`Primitive.${node}`);
...
var Portal = React20.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime17.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React21.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime18.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React21.isValidElement(newElement) ? React21.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime18.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  const Slot9 = createSlot6(`Primitive.${node}`);
  const Node2 = React22.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot9 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime19.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React23.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime20.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React23.isValidElement(newElement) ? React23.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable7(child) {
  return React23.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var Primitive7 = NODES7.reduce((primitive, node) => {
  const Slot9 = createSlot7(`Primitive.${node}`);
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime23.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime23.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime23.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime23.jsx)(
...
var SelectIcon = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive6.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
...
var SelectContent = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      const frag = fragment;
      return frag ? ReactDOM10.createPortal(
        (0, import_jsx_runtime23.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime23.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime23.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var Slot8 = createSlot6("SelectContent.RemoveScroll");
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime23.jsx)(Combination_default, { as: Slot8, allowPinchZoom: true, children: (0, import_jsx_runtime23.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
      ...
      (0, import_jsx_runtime23.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime23.jsx)(
        Primitive6.div,
        {
...
var SelectGroup = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime23.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime23.jsx)(Primitive6.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive6.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
      (0, import_jsx_runtime23.jsx)(Primitive6.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren ? ReactDOM10.createPortal(itemTextProps.children, context.valueNode) : null
    ] });
  }
);
...
var SelectItemIndicator = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime23.jsx)(Primitive6.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive6.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
