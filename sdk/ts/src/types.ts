...
export type AutomationBranch = Schemas["AutomationBranch-Input"];
export type AutomationSuspension = Schemas["AutomationSuspension"];
export type AutomationGuardrails = Schemas["AutomationGuardrails"];
export type AutomationDiagnostic = Schemas["AutomationDiagnostic"];
