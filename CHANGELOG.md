...
- **api**: project the WebSocket feed per connection
...
- **ui**: minimal synoptic editor (#666)
...
- **ui**: label the idle HVAC mode (#654)
...
- **devices-manager**: compile the json_path expression once per codec
...
- add pump standard type (AGR-1154) (#615)
...
- **devices-manager**: move device I/O observability to metrics (#533)
...
- **ui**: address AGR-1014 UI remarks
...
- **ui**: remove breadcrumbs and align page headers
...
- **timeseries**: apply AGR-879 review feedback
...
- add SDK resource namespaces for devices, drivers, transports and timeseries (AGR-375)
