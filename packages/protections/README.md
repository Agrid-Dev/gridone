...
`ProtectionsService` owns deployment-level rules guarding explicit device writes.
...
See `docs/specs/adr/0006-site-protections.md` for semantics and concurrency limits.
