...
/**
 * First ancestor of `asset` (excluding itself) typed `building`. `path` is the
 * root-down ancestry the API always sends, so it is the only source here — a
 * second parent-link walk would answer a different question when they disagree.
 */
