 ...
 * descriptions the driver declared for the attributes behind it. Renders
 * nothing when there is nothing to explain, so widgets without descriptions
 * look exactly as before. A single entry shows its text alone; several are
 * listed under their caption (e.g. the row each one belongs to).
 */
    ...
    <Tooltip delayDuration={0}>
      ...
      <TooltipPrimitive.Portal>
        <TooltipContent
          side="top"
          align="start"
          className="max-w-72 space-y-1 normal-case tracking-normal"
        >
          {entries.length === 1 ? (
