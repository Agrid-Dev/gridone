...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-end gap-2 border-b border-border bg-background/95 px-6 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <NavLink
        to="/notifications"
